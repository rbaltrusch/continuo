...
from harmony import find_min_change_in_smoothness
from harmony import find_missing_note
...
def fix_harmony(layers, scale_len, no_of_times):
    ...
    for _ in range(no_of_times):
        ...
        for i, layer in enumerate(layers):
            missing_note = find_missing_note(layer, scale_len)
            if i and not missing_note in current_notes:
                changednote, index = find_min_change_in_smoothness(
